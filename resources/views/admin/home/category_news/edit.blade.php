                ...
                <section class="content">
                    <div class="row">
                        ...
                        <div class="box box-warning">
                            ...
                            <!-- /.box-header -->
                            <div class="box-body">
                            <form role="form" action="{{route('edit_category_news')}}"   method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <input type="text" class="form-control" placeholder="Enter ..." name="id" value="{{ $category->id }}" style="display:none;">
                                ...
                                <div class="form-group">
                                    <label>Danh mục bài viết</label>
                                        <select class="form-control" name="id_parent">
                                            ...
                                            ?>
                                                <option value="{{ $key['id'] }}" <?= ($key['id']==$category->id_parent)? 'selected' : '' ?> >{{ $key["name"] }}</option>
                                            <?php } ?>
                                            <?php endforeach;?>
                                        </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" id="exampleInputFile" name="img" value="{{ $category->img }}">
                                    <?php
                                        if($category->img){
                                    ?>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox"  name="ishome" <?= ($category->ishome==1) ? 'checked' : '' ?> value='1'>
                                             Xuất hiện trang chủ
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Thứ tự</label>
                                    <input type="text" class="form-control" placeholder="Enter ..." name="order" value="{{ $category->order }}">
                                </div>
                                <div class="form-group">
                                    <label>Từ khóa</label>
