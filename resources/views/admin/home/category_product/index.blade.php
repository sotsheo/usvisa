                    ...
                    <div class="row">
                            ...
                            <div class="box">
                                    ...
                                    <h3 class="box-title">Danh mục sản phẩm</h3>
                                        <a type="btn" class="btn btn-success pull-right"  href="{{ url('admin/category_product/create') }}"><i class="fa  fa-plus-circle"></i> Thêm</a>
                                    </div>
                                    <!-- /.box-header -->
                                    <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <?php foreach ($category as $key ):?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('admin/category_product/edit') }}<?php echo('/'.$key['id']); ?>" title="Edit"> <i class="fa  fa-edit "></i></a> 
                                                    <a title="close" class="close_id" href="{{ url('admin/category_product/delete') }}<?php echo('/'.$key['id']); ?>"> 
