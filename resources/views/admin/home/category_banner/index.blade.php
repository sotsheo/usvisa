                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <a type="btn" class="btn btn-success pull-right"  href="{{ url('admin/category_banner/create') }}"><i class="fa  fa-plus-circle"></i> Thêm</a>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php foreach ($category_banner as $key ):?>
                                <tr>
                                   ...
                                   <td><?=( $key->state==0) ? 'Hiển thị' :'Ẩn' ?></td>     
                                    ...
                                    <td><a href="{{ url('admin/category_banner/edit') }}<?php echo('/'.$key->id); ?>" title="Edit"> <i class="fa  fa-edit "></i></a> <a title="close" class="close_id" href="{{ url('admin/category_banner/delete') }}<?php echo('/'.$key['id']); ?>"> <i class="fa  fa-close "></i></a></td>
