                ...
                <section class="content">
                    <div class="row">
                        ...
                        <div class="box box-warning">
                            ...
                            <!-- /.box-header -->
                            <div class="box-body">
                            <form role="form" action="{{route('edit_news')}}"   method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <input type="text" class="form-control" placeholder="Enter ..." name="id" value="{{$news->id}}" style="display:none">
                                ...
                                <div class="form-group select_a">
                                    <label>Danh mục bài viết</label>
                                        <select class="form-control" name="id_category">
                                            ...
                                            ?>
                                                <option value="{{$item->id}}" <?=($item->id==$news->id_category) ? 'selected' :'' ?>>{{$item->name}}</option>
                                            <?php }?>
                                        </select>
                                        <span class="text-red"></span>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox"  name="ishot" <?= ($news->ishot==1) ? 'checked' : '' ?> value='1'>
                                             Bài viết nổi bật
                                        </label>
                                    </div>
                                </div>
